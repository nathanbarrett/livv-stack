...
- This project uses the LIVV Stack: Laravel 12.x, Inertia.js, Vue 3 with TypeScript, and Vuetify 3.
...
- Always assume that `npm run dev` (Vite) is already running somewhere
